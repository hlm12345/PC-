    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <!-- 分类的面包屑 -->
            <li class="with-x" v-show="searchParams.categoryName">{{searchParams.categoryName}}<i @click="removeName">×</i></li>
            <!-- 关键字的面包屑 -->
        ...
        <!-- selector -->
        <Selector @trademarkInfo="trademarkInfo" @attrInfo="attrInfo"></Selector>
        <!--details-->
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click.prevent="changeOrder('1')">
                  <a href="#">综合<span v-show="isOne" class="iconfont" :class="{'icon-down': desc,'icon-up':asc}"></span></a>
                </li>
                <li :class="{active: isTwo}" @click.prevent="changeOrder('2')">
                  <a href="#">价格<span v-show="isTwo" class="iconfont" :class="{'icon-down': desc,'icon-up':asc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
